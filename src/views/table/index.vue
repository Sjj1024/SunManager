  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="等级" prop="level">
        <el-select v-model="formInline.level" placeholder="活动区域">
          <el-option label="新手上路" value="shanghai" />
          <el-option label="侠客" value="beijing" />
          <el-option label="騎士" value="beijing" />
          <el-option label="圣騎士" value="beijing" />
          <el-option label="精靈王" value="beijing" />
          <el-option label="風云使者" value="beijing" />
          <el-option label="光明使者" value="beijing" />
          <el-option label="天使" value="beijing" />
        </el-select>
      </el-form-item>
      <el-form-item label="威望" prop="weiwang">
        <el-input v-model="formInline.weiwang" placeholder="威望" />
      </el-form-item>
      <el-form-item label="可产邀请码" prop="yaoqing">
        <el-select v-model="formInline.yaoqing" placeholder="可产邀请码">
    ...
    >
      <el-table-column align="center" label="用户名" width="150">
        <template slot-scope="scope"> 真的不好意思 </template>
      </el-table-column>
      ...
      <el-table-column label="威望" width="110" align="center">
        <template slot-scope="scope">
          <span>180000 點</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="金钱" width="140" align="center">
        <template slot-scope="scope">
          <span>2137684179 USD</span>
        </template>
      </el-table-column>
      <el-table-column align="center" width="140" label="发帖/回复/点评">
      ...
      <el-table-column align="center" width="130" label="可产邀请码">
